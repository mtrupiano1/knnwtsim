...
The weights `alpha`, `beta`, and `gamma` are recommended sum to 1. In this case each element of `S_w` should also be between 0-1, with the diagonal elements being equal to 1. 
